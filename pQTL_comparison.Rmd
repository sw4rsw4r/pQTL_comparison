...
```{r}
combined <- bind_rows(
  get_all_results("CASE1", c("group1", "group2")),
  get_all_results("CASE2F", c("Somascan", "Olink")),
  get_all_results("CASE2U", c("Somascan", "Olink")),
  get_all_results("CASE3", c("FinnGen", "UKBB")),
  get_all_results("CASE3_FinnGenLD", c("FinnGen", "UKBB")),
  get_all_results("CASE3_UKBBLD", c("FinnGen", "UKBB")),
  get_all_results("CASE4", c("FinnGen", "EGA")),
  get_all_results("CASE4_FinnGenLD", c("FinnGen", "EGA")),
  get_all_results("CASE4_UKBBLD", c("FinnGen", "EGA"))
)
