...
combined <- bind_rows(
  ...
  get_all_results("CASE2B", c("Somascan", "Olink")),
  get_all_results("CASE2F", c("Somascan", "Olink")),
  get_all_results("CASE3", c("FinnGen", "UKBB")),
  get_all_results("CASE3F_LD", c("FinnGen", "UKBB")),
  get_all_results("CASE3B_LD", c("FinnGen", "UKBB")),
  get_all_results("CASE4", c("FinnGen", "EGA")),
  get_all_results("CASE4F_LD", c("FinnGen", "EGA")),
  get_all_results("CASE4B_LD", c("FinnGen", "EGA"))
)
